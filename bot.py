...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel', url='http://telegram.me/SAITAMA_BOTZ'),
        InlineKeyboardButton('Source Code', url='https://github.com/MTG33/Tele-graph')
    ]]
